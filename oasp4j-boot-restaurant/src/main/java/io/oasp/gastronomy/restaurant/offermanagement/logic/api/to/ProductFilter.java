...
public class ProductFilter extends AbstractTransferObject {
   ...
   * Constructor.
   *
   * @param fetchDrinks is the flag for getting {@link io.oasp.gastronomy.restaurant.offermanagement.logic.api.to.DrinkEto drinks} from db (set this to <code>true</code>)
   * @param fetchMeals is the flag for getting {@link io.oasp.gastronomy.restaurant.offermanagement.logic.api.to.MealEto meals} from db (set this to <code>true</code>)
   * @param fetchSideDishes is the flag for getting {@link io.oasp.gastronomy.restaurant.offermanagement.logic.api.to.SideDishEto side dishes} from db (set this to
   *        <code>true</code>)
   */
