...
/**
 * {@link io.oasp.gastronomy.restaurant.general.dataaccess.api.ApplicationPersistenceEntity Entity} that represents a single position of an {@link io.oasp.gastronomy.restaurant.salesmanagement.dataaccess.api.OrderEntity}.
 *
 * @author hohwille
 */
...
public class OrderPositionEntity extends ApplicationPersistenceEntity implements OrderPosition {
  ...
  /**
   * @return the {@link io.oasp.gastronomy.restaurant.salesmanagement.dataaccess.api.OrderEntity order} this {@link io.oasp.gastronomy.restaurant.salesmanagement.dataaccess.api.OrderPositionEntity} is associated with.
   */
