...
public class StaffmanagementRestServiceImpl {
  ...
  /**
   * @return a list of all {@link io.oasp.gastronomy.restaurant.staffmanagement.logic.api.to.StaffMemberEto}
   *
   */
  @GET
  @Path("/")
   ...
   * @return {@link io.oasp.gastronomy.restaurant.staffmanagement.logic.api.to.StaffMemberEto}
   */
  @GET
  @Path("/{login}")
  @RolesAllowed(PermissionConstants.FIND_STAFF_MEMBER)
