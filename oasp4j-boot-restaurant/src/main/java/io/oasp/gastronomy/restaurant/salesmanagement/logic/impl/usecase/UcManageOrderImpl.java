...
public class UcManageOrderImpl extends AbstractOrderUc implements UcManageOrder {
  ...
  /**
   * @param salesmanagement the {@link io.oasp.gastronomy.restaurant.salesmanagement.logic.api.Salesmanagement} to {@link Inject}.
   */
  @Inject
  ...
  /**
   * @param order is the {@link io.oasp.gastronomy.restaurant.salesmanagement.logic.api.to.OrderCto} to save or update.
   * @param targetOrder is the existing {@link OrderEntity} or <code>null</code> in case of a new {@link io.oasp.gastronomy.restaurant.salesmanagement.logic.api.to.OrderCto} to
   *        save.
   */
