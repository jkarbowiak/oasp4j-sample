...
/**
 * {@link io.oasp.gastronomy.restaurant.general.dataaccess.api.ApplicationPersistenceEntity Entity} that represents the bill related to one or multiple {@OrderPosition
 *  order positions}.
 *
 * @author etomety
 */
