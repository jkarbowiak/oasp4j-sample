...
/**
 * Implementation of {@link io.oasp.gastronomy.restaurant.salesmanagement.logic.api.usecase.UcManageOrderPosition}.
 *
 * @author jozitz
 */
@Named
public class UcManageOrderPositionImpl extends AbstractOrderPositionUc implements UcManageOrderPosition {
  ...
  /**
   * @param offerManagement the {@link io.oasp.gastronomy.restaurant.offermanagement.logic.api.Offermanagement} to {@link Inject}.
   */
  @Inject
