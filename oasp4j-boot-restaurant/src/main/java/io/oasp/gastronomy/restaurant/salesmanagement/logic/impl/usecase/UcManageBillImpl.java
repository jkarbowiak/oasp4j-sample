...
/**
 * Implementation of {@link io.oasp.gastronomy.restaurant.salesmanagement.logic.api.usecase.UcManageBill}.
 *
 * @author jozitz
 */
@Named
public class UcManageBillImpl extends AbstractBillUc implements UcManageBill {
   ...
   * {@link io.oasp.gastronomy.restaurant.salesmanagement.logic.impl.usecase.UcManageBillImpl#create(java.util.List, io.oasp.gastronomy.restaurant.general.common.api.datatype.Money)}. Otherwise, the existing {@link BillEntity} will be updated by
