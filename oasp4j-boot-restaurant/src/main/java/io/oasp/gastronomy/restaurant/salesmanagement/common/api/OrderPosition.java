...
/**
 * This is the interface for an {@link io.oasp.gastronomy.restaurant.salesmanagement.common.api.OrderPosition}.
 *
 * @author hohwille
 */
public interface OrderPosition extends ApplicationEntity {
  ...
  /**
   * @return the {@link io.oasp.gastronomy.restaurant.salesmanagement.common.api.Order#getId ID} of the {@link io.oasp.gastronomy.restaurant.salesmanagement.common.api.Order} this {@link io.oasp.gastronomy.restaurant.salesmanagement.common.api.OrderPosition} belongs to.
   */
  Long getOrderId();
   ...
   *         {@link io.oasp.gastronomy.restaurant.offermanagement.common.api.Offer} for historic {@link io.oasp.gastronomy.restaurant.salesmanagement.common.api.OrderPosition}s.
   */
  Long getOfferId();
  ...
  /**
   * @return the current {@link io.oasp.gastronomy.restaurant.salesmanagement.common.api.datatype.OrderPositionState state}.
   */
  ...
  /**
   * @return the comment for this {@link io.oasp.gastronomy.restaurant.salesmanagement.common.api.OrderPosition} (e.g. "extra spicy").
   */
  String getComment();
