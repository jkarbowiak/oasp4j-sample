...
public interface UcFindTable {
   ...
   * @return The restaurant {@link io.oasp.gastronomy.restaurant.tablemanagement.logic.api.to.TableEto} with id 'id'
   */
   ...
   * 
   * @return {@link java.util.List} of all existing restaurant {@link io.oasp.gastronomy.restaurant.tablemanagement.logic.api.to.TableEto}s
   */
   ...
   * 
   * @return {@link java.util.List} of all existing free restaurant {@link io.oasp.gastronomy.restaurant.tablemanagement.logic.api.to.TableEto}s
   */
