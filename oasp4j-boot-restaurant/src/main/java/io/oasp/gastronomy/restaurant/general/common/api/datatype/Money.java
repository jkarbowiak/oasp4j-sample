...
public class Money extends AbstractSimpleDatatype<BigDecimal> {
  ...
  /** A {@link io.oasp.gastronomy.restaurant.general.common.api.datatype.Money} instance where the {@link #getValue() amount} is <code>0</code>. */
  ...
  /**
   * @return the currency the {@link io.oasp.gastronomy.restaurant.general.common.api.datatype.Money} is represented in.
   */
  ...
  /**
   * @param money is the {@link io.oasp.gastronomy.restaurant.general.common.api.datatype.Money} to add.
   * @return the sum of this {@link io.oasp.gastronomy.restaurant.general.common.api.datatype.Money} and the given <code>money</code>.
   */
