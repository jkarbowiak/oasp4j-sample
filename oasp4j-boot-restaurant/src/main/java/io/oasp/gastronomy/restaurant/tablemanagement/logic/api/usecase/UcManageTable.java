...
public interface UcManageTable {
   ...
   *
   * @param table the {@link io.oasp.gastronomy.restaurant.tablemanagement.logic.api.to.TableEto} to create.
   * @return the new {@link io.oasp.gastronomy.restaurant.tablemanagement.logic.api.to.TableEto} that has been saved with ID and version.
   */
   ...
   *
   * @param table {@link io.oasp.gastronomy.restaurant.tablemanagement.logic.api.to.TableEto} to be evaluate
