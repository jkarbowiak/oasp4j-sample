...
public class UserData extends User implements Principal {
  ...
  /**
   * @return an instance of {@link io.oasp.gastronomy.restaurant.general.common.api.to.UserDetailsClientTo} with the client side representation of this {@link io.oasp.gastronomy.restaurant.general.common.api.security.UserData}
   *         instance.
   */
  ...
  /**
   * @return the {@link io.oasp.gastronomy.restaurant.general.common.api.security.UserData} of the user currently logged in.
   */
   ...
   * @return the {@link io.oasp.gastronomy.restaurant.general.common.api.security.UserData} of the logged in user from the given {@link Authentication}.
   */
