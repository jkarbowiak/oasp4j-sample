 ...
 * {@link io.oasp.gastronomy.restaurant.tablemanagement.common.api.datatype.TableState#isReserved() reserved}, {@link io.oasp.gastronomy.restaurant.tablemanagement.common.api.datatype.TableState#isOccupied() occupied} and may have a
...
public interface Table extends ApplicationEntity {
  ...
  /**
   * @return the current {@link io.oasp.gastronomy.restaurant.tablemanagement.common.api.datatype.TableState state} of this {@link io.oasp.gastronomy.restaurant.tablemanagement.common.api.Table}.
   */
  TableState getState();
