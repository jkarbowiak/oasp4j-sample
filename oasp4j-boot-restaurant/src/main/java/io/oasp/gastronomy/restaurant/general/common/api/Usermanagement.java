...
public interface Usermanagement {
   ...
   * @return The {@link io.oasp.gastronomy.restaurant.general.common.api.UserProfile} with the given <code>login</code> or <code>null</code> if no such object exists.
   */
