...
/**
 * This is the interface for a {@link io.oasp.gastronomy.restaurant.salesmanagement.common.api.Bill}. It represents the actual payment for an {@link Order}.
 *
 * @author hohwille
 */
public interface Bill extends ApplicationEntity {
  ...
  /**
   * @return the total amount that has to be payed for this {@link io.oasp.gastronomy.restaurant.salesmanagement.common.api.Bill}.
   */
  ...
  /**
   * @return <code>true</code> if this {@link io.oasp.gastronomy.restaurant.salesmanagement.common.api.Bill} has been payed, <code>false</code> otherwise.
   */
  boolean isPayed();
  ...
  /**
   * @return the {@link java.util.List} with the {@link OrderPosition#getId() IDs} of the {@link OrderPosition}s.
   */
